        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/padel.58/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-padel-blue rounded-full flex items-center justify-center hover:bg-padel-blue-light transition-colors">
